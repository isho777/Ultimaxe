...
<div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel" >
            <div class="x_title">
                <h2>Update System Product <small> Please fill the below form fields with the approprite information.</small></h2>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <div class="input-group date" id="myDatepicker" >
                                    ...
                                    <input type="text" class="form-control" name="pserial" value="{{$products->serialnumber}}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <div class="input-group date" id="myDatepicker2">
                                    ...
                                    <input type="text" class="form-control" name="pname" value="{{$products->p_name}}" required>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="input-group date" id="myDatepicker3">
                                    ...
                                    <select class="form-control" name="pack">
                                      @foreach($packs as $pack)
                                          ...
                                          @if($products->p_size == $pack->id)
                                          selected
                                          @endif
                                          >{{$pack->packsize.''.$pack->weightunit}}</option>
                                          @endforeach
                                    </select>
                                </div>
                            </div>
